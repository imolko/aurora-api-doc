...
[![Build Status](https://travis-ci.org/:imolko/aurora-api-doc.svg?branch=master)](https://travis-ci.org/:imolko/aurora-api-doc)
...
6. If you did everything correct, https://:imolko.github.io/aurora-api-doc/ will lead to your new docs
...
- Documentation(ReDoc): https://:imolko.github.io/aurora-api-doc/
- SwaggerUI: https://:imolko.github.io/aurora-api-doc/swagger-ui/
- Look full spec:
    + JSON https://:imolko.github.io/aurora-api-doc/swagger.json
    + YAML https://:imolko.github.io/aurora-api-doc/swagger.yaml
- Preview spec version for branch `[branch]`: https://:imolko.github.io/aurora-api-doc/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://:imolko.github.io/aurora-api-doc/ with url from the message: `Server started <url>`
